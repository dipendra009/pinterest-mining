function createModel(nGPU)
   ...
   features:add(nn.SpatialConvolutionCuFFT(64,192,5,5,1,1))       --  27 -> 27
   ...
   features:add(nn.SpatialConvolutionCuFFT(192,384,3,3,1,1))      --  13 ->  13
   features:add(nn.SpatialBatchNormalization(384,1e-3))
   features:add(cudnn.ReLU(true))
   features:add(nn.SpatialZeroPadding(1,1,1,1))
   features:add(nn.SpatialConvolutionCuFFT(384,256,3,3,1,1))      --  13 ->  13
   features:add(nn.SpatialBatchNormalization(256,1e-3))
   features:add(cudnn.ReLU(true))
   features:add(nn.SpatialZeroPadding(1,1,1,1))
   features:add(nn.SpatialConvolutionCuFFT(256,256,3,3,1,1))      --  13 ->  13
   features:add(nn.SpatialBatchNormalization(256,1e-3))
   features:add(cudnn.ReLU(true))
