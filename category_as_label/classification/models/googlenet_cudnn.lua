...
function createModel(nGPU)
   ...
   features:add(cudnn.SpatialConvolution(3,64,7,7,2,2,3,3)):add(cudnn.ReLU(true))
   features:add(cudnn.SpatialMaxPooling(3,3,2,2):ceil())
   features:add(cudnn.SpatialConvolution(64,64,1,1)):add(cudnn.ReLU(true))
   features:add(cudnn.SpatialConvolution(64,192,3,3,1,1,1,1)):add(cudnn.ReLU(true))
   features:add(cudnn.SpatialMaxPooling(3,3,2,2):ceil())
